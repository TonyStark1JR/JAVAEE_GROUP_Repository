  ...
  <body>
    ...
    <!-- Page Content-->
      <main class="page-content"> 
         <section class="section-60 section-sm-95 bg-image bg-image-2 text-center section-sm-bottom-60">
          <div class="shell text-center">
            <h1 class="txt-white">ships</h1>
            <div class="range">
              <div class="cell-lg-8 cell-lg-preffix-2">               
                <!-- RD Mailform-->
                <form class="rd-mailform text-left form-search">
                  <p class="small text-xs-right">Searching for a Ship</p>
        ...
        <section class="section-71 section-bottom-80">
          <div class="shell">
            <h2>Today's Ship Deals</h2>
            <div class="range">
              <div class="cell-sm-6"><img src="<%=basePath%>/images/index2.jpg" alt="" width="570" height="321">
